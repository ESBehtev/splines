...
## 1. Интерполяция данных с пропусками ([p_spline_gapped_data_interpolation.py](Исходники/p_spline_gapped_data_interpolation.py))
...
## 2. Интерполяция с использованием P-сплайнов и пропусками ([p_spline_interpolation_with_gaps.py](Исходники/p_spline_interpolation_with_gaps.py))
...
## 3. Интерполяция шумных данных с P-сплайнами ([p_spline_noisy_data.py](Исходники/p_spline_noisy_data.py))
...
## 4. Оценка B-сплайна ([spline_evaluation.py](Исходники/spline_evaluation.py))
...
## 5. Интерполяция с B-сплайнами ([spline_interpolation.py](Исходники/spline_interpolation.py))
